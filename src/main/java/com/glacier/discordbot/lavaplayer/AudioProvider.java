package com.glacier.discordbot.lavaplayer;
...
/**
 * As with GuildMusicManager and TrackScheduler, I've pulled this code from the D4J example bot
 * I'll only be adding changes if necessary (i.e. lastFrame.data changed to lastFrame.getData())
 * 
